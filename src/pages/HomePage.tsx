...
const DEFAULT_THEMES: Record<ThemeName, ThemeConfig> = {
  ...
  apple: { heroImageUrl: "/Ehsan-Banner-Orange-Glass-side-2X.png", portraitImageUrl: "/Black and White no glass.jpg", accentColor: "#ff7a18", heroLine1: "Building the", heroLine2: "unbuildable.", heroSubtitle: "Facade BIM, computational design and digital delivery—where ambitious architecture becomes coordinated, controlled and real.", showParticles: false, showFloatingPanels: false, mediaRail: [
    ...
    { image: "/projects/atlassian-central-aerial.avif", label: "CURRENT PROJECT · SYDNEY", title: "Atlassian Central — façade in delivery", description: "The hybrid-timber tower’s complex envelope taking physical form.", detail: "Atlassian Central combines a steel exoskeleton, mass-timber neighbourhoods and an innovative glass-and-steel façade. This construction view brings the digital coordination challenge into focus: geometry, brackets, interfaces and installation sequencing must work as one controlled system.", wide: true },
    { image: "/projects/atlassian-central-forbes.jpg", label: "FACADE PERFORMANCE", title: "Atlassian Central — climate envelope", description: "Operable glazing, shading and planted terraces integrated into one façade strategy.", detail: "The façade is designed around Sydney’s temperate climate, combining natural ventilation, self-shading and planted terraces. BIM management connects the architectural ambition to repeatable assemblies, interface control and fabrication-ready information." },
    { image: "/projects/project-reference-google.jpg", label: "CURRENT PROJECT · DUNEDIN", title: "New Dunedin Hospital", description: "A resilient healthcare façade delivered through coordinated systems.", detail: "The Outpatient Building combines high-performance glazing, cladding and carefully controlled interfaces. Healthcare delivery places a premium on dependable information, seismic and weather performance, maintainability and disciplined coordination across every façade package.", wide: true },
